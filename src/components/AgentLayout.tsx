                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <button
                      onClick={() => {
                        ...
                        const j = async () => {
                          const r = await fetch('https://apphelp-cugtbgavhge7eqbn.uksouth-01.azurewebsites.net/status/adam')
                          const data = await r.json()
                          if (data.active === 'true') {
                            isAlreadyActive = true
                            return
                          }
                          await fetch('https://apphelp-cugtbgavhge7eqbn.uksouth-01.azurewebsites.net/status/adam', {
                            method: 'PUT',
                            body: JSON.stringify({
                              "key": "active",
